...
\begin{enumerate}
    ...
    \item \textbf{Limitaci\'on de portabilidad:} \texttt{seq\_search} aunque funciona en Gecode, no se puede aplicar Estrategia 2 a HiGHS para verificar si mejora a\'un m\'as sus ya excelentes resultados.
\end{enumerate}
